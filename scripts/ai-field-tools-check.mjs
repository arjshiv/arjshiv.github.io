...
if (!desktop.heading.includes("I'm building ResiDesk")) failures.push('Hero heading did not render.');
...
if (!noScriptText.includes('Renting is expensive and weirdly bad')) failures.push('Core story is not readable with JavaScript disabled.');
