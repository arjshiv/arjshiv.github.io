(() => {
  ...
  const signalFixtures = {
    garden: ['The laundry app charged me twice again and nobody can explain it.', 'Can someone fix the courtyard lights before dark?', 'My renewal offer went up even though the pool has been closed.', 'Package room door is stuck.'],
  ...
  const tuesdayClaims = {
    ...
    sales: 'The demo writes a sales follow-up.',
