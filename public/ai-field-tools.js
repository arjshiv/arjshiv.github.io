  ...
  const corpus = [
    {
      ...
      title: 'ResiDesk',
      href: '#now',
      text: 'I co-founded ResiDesk to help property teams turn resident texts, reviews, tickets, and calls into answers, history, and follow-up the team can act on without rereading everything.',
