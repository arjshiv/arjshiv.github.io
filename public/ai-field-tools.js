(() => {
  ...
  const tweakBriefs = {
    legibility: {
      ...
      steps: ['Audit hover states first; text should never get lighter or less legible during motion.', 'Keep long paragraphs under 68 characters per line on desktop.', 'Use borders to group choices, not to outline every empty surface.'],
    },
    speed: {
      title: 'Speed fix',
