(() => {
  ...
  const talkLenses = {
    ...
    greg: ['The useful part of AI is leverage inside real company work.', 'Context has to travel with the task.', 'A product is only good if it changes what someone does next.'],
