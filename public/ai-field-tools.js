(() => {
  const corpus = [
    ...
    },
    {
      ...
      title: 'Climb Credit',
      href: '#about',
      text: 'At Climb Credit, we asked what happened after the program. That pushed outcomes into underwriting, product, and data while annual loan volume moved from 1 million dollars to 300 million dollars.',
