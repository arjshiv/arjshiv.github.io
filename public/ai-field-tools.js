(() => {
  const corpus = [
    {
      ...
      title: 'ResiDesk',
      href: '#now',
      text: 'I co-founded ResiDesk to help property teams turn resident texts, reviews, tickets, and calls into answers, building history, and follow-up the team can act on without rereading the whole history.',
    ...
    },
    {
      ...
      title: 'AI view',
      href: '#writing',
      text: 'I care about AI that works on a normal Tuesday. History, evals, handoff, trust, and judgment matter more than novelty or model names.',
  ...
  const talkLenses = {
    ...
    greg: ['The useful part of AI is leverage inside real company work.', 'The right history has to travel with the task.', 'A product is only good if it changes what someone does next.'],
